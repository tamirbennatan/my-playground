...
first_page %>%
      ...
      facet_zoom(xy = between(date, as.Date("2016-06-01"), as.Date("2016-07-01")), horizontal = FALSE, zoom.size = .6)
```
...
nested %>%
      ...
      facet_zoom(xy = between(date, as.Date("2016-02-01"), as.Date("2016-03-01")), horizontal = FALSE, zoom.size = .5)
...
nested %>%
      select(Page) %>%
      filter(str_detect(pattern = "_commons.wikimedia.org_", Page))
